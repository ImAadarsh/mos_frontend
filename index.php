...
<body class="index-page">
    ...
    <main class="main-area fix">
        ...
        <!-- banner-area -->
        <section class="banner-area banner-bg-five banner-align-centered tg-motion-effects"
            data-background="assets/img/banner-hh.png">
            <div class="banner-clouds-wrapper">
                <div class="banner-cloud-layer cloud-layer-1" data-background="assets/img/banner/h5_hero_bg_shape.svg">
                </div>
                <div class="banner-cloud-layer cloud-layer-2" data-background="assets/img/banner/h5_hero_bg_shape.svg">
                </div>
                <div class="banner-cloud-layer cloud-layer-3" data-background="assets/img/banner/h5_hero_bg_shape.svg">
                </div>
                <div class="banner-cloud-layer cloud-layer-4" data-background="assets/img/banner/h5_hero_bg_shape.svg">
                </div>
            </div>
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-xl-5 col-lg-5">
                        <div class="banner__content-five">
                            <span class="sub-title" data-aos="fade-right" data-aos-delay="200">Unlock Your Potential
                                with the Magic of Skills!</span>
                            <h2 class="title" data-aos="fade-right" data-aos-delay="400">World-Class <span> Workshops
                                    for </span>&nbsp;Future Leaders.</h2>
                            <p data-aos="fade-right" data-aos-delay="600">A fun and interactive space to transform your
                                interests into powerful life skills! Discover, Learn & Grow with the Magic of Skills!
                            </p>
                            <div class="banner__btn" data-aos="fade-right" data-aos-delay="800">
                                <a href="login.php" class="btn arrow-btn">Start Your Journey Now <img
                        ...
                        <div class="banner__images-five">
                            ...
                            <div class="shape-wrap">
                                ...
                                <div class="shape-two" data-aos="fade-down-left" data-aos-delay="800">
                                    <img src="assets/img/banner/h5_hero_shape05.svg" alt="shape"
            ...
            <div class="banner__shape-wrap-two">
                <img src="assets/img/banner/h5_hero_shape01.svg" alt="shape" data-aos="fade-right"
                    data-aos-delay="1000">
            ...
            <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="section__title text-center">
                                ...
                                <h2 class="title" style="font-size: 28px; margin-bottom: 8px;">Discover Workshops That
                                    Inspire You to Do More</h2>
                                <p class="desc" style="font-size: 13px; margin-top: 8px; width: 80%; margin: 0 auto;">
                                    Step into a world of ideas, challenges, and hands-on activities. Each workshop is
                                    designed to spark curiosity, build new abilities, and help you explore what you're
                                    truly capable of.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    $sql = "SELECT workshops.*, categories.name AS category_name, categories.id AS category_id, trainers.name AS trainer_name 
                                            ...
                                            WHERE workshops.is_visible=1 AND workshops.is_deleted=0 AND workshops.is_completed=0
                                            LIMIT 6";
                            ...
                            <div class="workshop-card-compact">
                                <div class="workshop-thumb-compact">
                                    <a href="course-details.php?id=<?php echo $final['id']; ?>">
                                        <img src="<?php echo $uri . $final['banner_image'] ?>"
                                            alt="<?php echo htmlspecialchars($final['name']); ?>">
                                    </a>
                                </div>
                                <div class="workshop-body-compact">
                                    <a href="course-details.php?id=<?php echo $final['id']; ?>"
                                        class="workshop-category-badge"><?php echo htmlspecialchars($final['category_name']); ?></a>
                                    <h5 class="workshop-title-compact">
                                        <a
                                            href="course-details.php?id=<?php echo $final['id']; ?>"><?php echo htmlspecialchars($final['name']); ?></a>
                                    </h5>
                                    <p class="workshop-trainer-compact">By <a
                                            href="#"><?php echo htmlspecialchars($final['trainer_name']); ?></a></p>
                                    <div class="workshop-meta-compact">
                                        ...
                                        <div class="workshop-meta-item">
                                            <span
                                                class="workshop-level-badge <?php echo $level_class; ?>"><?php echo $level_text; ?></span>
                                        </div>
                                    </div>
                                    <div class="workshop-footer-compact">
                                        <h5 class="workshop-price-compact">
                                            ₹<?php echo $final['is_completed'] ? number_format($final['record_price']) : number_format($final['price']); ?>
                                        </h5>
                                        <?php if ($is_coming_soon) { ?>
                                            <span class="workshop-coming-soon">Coming Soon</span>
                                        <?php } else { ?>
                                            <a href="course-details.php?id=<?php echo $final['id']; ?>"
                                                class="workshop-btn-compact">Enroll Now</a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="features__area-three section-pb-90 features-compact-area">
            ...
            <div class="container">
                <div class="row justify-content-center mb-30">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section__title text-center">
                            ...
                            <p>Everything you need to grow with confidence — bite-sized, practical, and people-first.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="features-compact-grid">
                    ...
                    <div class="features-compact-card">
                        <div class="features-compact-icon">
                            <img src="assets/img/icons/h2_features_icon02.svg" alt="Effective Workshops"
                                class="injectable">
                        </div>
                        <div>
        ...
        <section class="about-area-five">
                ...
                <div class="col-lg-6">
                    <div class="about__content-five">
                        ...
                        <p>Magic of Skills is a creative learning space where students discover what they’re good at and
                            what they love doing. We turn everyday curiosity into practical skills through fun
                            activities, challenges, and interactive workshops. <br>From communication to creativity and
                            confidence to content creation, this is where you learn things that actually matter in real
                            life. </p>
                        ...
                        <ul class="about__info-list list-wrap">
                            ...
                            <li class="about__info-list-item">
                                <i class="flaticon-angle-right"></i>
                                <p class="content">Personal student dashboard for registrations and progress tracking
                                </p>
                            </li>
                            <li class="about__info-list-item">
                                <i class="flaticon-angle-right"></i>
                        ...
                        <div class="about__content-bottom">
                            <a href="login.php" class="btn arrow-btn">Start for Free <img
            ...
            <div class="about__shape">
                <img src="assets/img/others/h5_about_shape01.png" alt="shape" data-aos="fade-right"
                    data-aos-delay="800">
            </div>
        </section>
        <!-- about-area-end -->
        ...
        <section class="testimonial__area-four tg-motion-effects">
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-5 col-md-7">
                        <div class="testimonial__img-two">
                            ...
                            <div class="shape">
                                <img src="assets/img/others/h5_testimonial_shape01.svg" alt="shape"
                                    class="alltuchtopdown">
                                <img src="assets/img/others/h5_testimonial_shape02.svg" alt="shape"
                                    class="tg-motion-effects4">
                                <img src="assets/img/others/h5_testimonial_shape03.svg" alt="shape"
                                    class="tg-motion-effects3">
                            </div>
                        </div>
                    </div>
            ...
            <div class="testimonial__shape-wrap">
                <img src="assets/img/others/h5_testimonial_shape04.svg" alt="shape" data-aos="fade-up"
                    data-aos-delay="400">
                <img src="assets/img/others/h5_testimonial_shape05.svg" alt="shape" data-aos="fade-down-left"
                    data-aos-delay="400">
            </div>
        </section>
                            ...
                            <div class="blog__post-item-four shine__animate-item">
                                <div class="blog__post-thumb-four">
                                    <a href="blog-details.php?id=<?php echo $finalr['id'] ?>"
                                        class="shine__animate-link"><img src="<?php echo $uri . $finalr['icon'] ?>"
                                            alt="img"></a>
                                </div>
                                <div class="blog__post-content-four">
                                    <a href="blog.php" class="post-tag-three"><?php echo $finalr['cat_name'] ?></a>
                                    <h2 class="title"><a
                                            href="blog-details.php?id=<?php echo $finalr['id'] ?>"><?php echo $finalr['title'] ?></a>
                                    </h2>
                                    <div class="blog__post-meta">
                                        <ul class="list-wrap">
                                            <li><i class="flaticon-user-1"></i>by <a
                                                    href="blog-details.php?id=<?php echo $finalr['id'] ?>"><?php echo $finalr['author_name'] ?></a>
                                            </li>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        while ($finalr2 = $sider2->fetch_assoc()) { ?>
                            <div class="swiper-slide">
                                <div class="blog__post-item-four shine__animate-item">
                                    <div class="blog__post-thumb-four">
                                        <a href="blog-details.php?id=<?php echo $finalr2['id'] ?>"
                                            class="shine__animate-link"><img src="<?php echo $uri . $finalr2['icon'] ?>"
                                                alt="img"></a>
                                    </div>
                                    <div class="blog__post-content-four">
                                        <a href="blog.php" class="post-tag-three"><?php echo $finalr2['cat_name'] ?></a>
                                        <h2 class="title"><a
                                                href="blog-details.php?id=<?php echo $finalr2['id'] ?>"><?php echo $finalr2['title'] ?></a>
                                        </h2>
                                        <div class="blog__post-meta">
                                            <ul class="list-wrap">
                                                <li><i class="flaticon-user-1"></i>by <a
                                                        href="blog-details.php?id=<?php echo $finalr2['id'] ?>"><?php echo $finalr2['author_name'] ?></a>
                                                </li>
                                                <li><i class="flaticon-calendar"></i><?php
