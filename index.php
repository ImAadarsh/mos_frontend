...
<?php include "include/header.php" ?>
    ...
    <main class="main-area fix">
        ...
        <!-- banner-area -->
        <section class="banner-area banner-bg-five tg-motion-effects" data-background="assets/img/banner-hh.png">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-five">
                            ...
                            <div class="about__content-bottom">
                                <a href="contact.php" class="btn arrow-btn">Start Free Trial <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                                    ...
                                    <div class="instructor__item">
                                        ...
                                        <div class="instructor__content">
                                            ...
                                            <p class="avg-rating">
                                                ...
                                                ?>
                                                (<?php echo $feedback_data['review_count']; ?> reviews)
                                            </p>
                                            <?php } ?>
