...
<head>
    ...
    <title>Magic of Skills Invoice</title>
    <meta name="author" content="endeavourdigital.in">
    <meta name="description" content="Magic of Skills">
    <meta name="keywords" content="Magic of Skills, Invoice" />
                        ...
                        <div class="row justify-content-between mb-30 mt-5 pt-4">
                            ...
                            <div class="col-auto">
                                <div class="invoice-left">
                                    <b>Magic Of Skills:</b>
                                    <address>
                                    Eduace Services Pvt Ltd,<br>
                                    112 Opel Regency, E 8 Arera Colony,  <br>Bhopal(M.P) 462016 
                                    <br>
                                    GSTIN 23AABCU5512H1ZO
        ...
        <?php } ?>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                ...
                                <div class="invoice-left">
                                    <b>Importants</b>
                                    <p class="mb-0">You can find all the details about your Workshops <br> in your dashboard.<br>
                                </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="body-shape1">
                        <img src="assets/img/template/photography_shape.svg" alt="shape">
                    </div>
                    <div class="body-shape2">
                        <img src="assets/img/template/photography_footer.svg" alt="shape">
                    </div>
