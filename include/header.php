                                            ...
                                            <ul class="sub-menu mega-menu">
                                                <li>
                                                    <ul class="list-wrap mega-sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="courses.php?is_completed=0">Upcoming Workshops <span class="tg-badge-two">New</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="courses.php?is_completed=1">Previous Workshops <span class="tg-badge">Prev</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="courses.php?is_free=1">Free Workshops<span class="tg-badge-two">New</span></a>
                                                        </li>
                                                ...
                                                <li>
                                                    ...
                                                    <li class="active">
                                                        ...
                                                        <?php
                                                            ...
                                                            ?>
                                                                <li>
                                                                    <a href="courses.php?category_id=<?php echo $headercategoryFinal['id']; ?>">
                                ...
                                <div class="tgmenu__search d-none d-md-block">
                                    <form action="courses.php" method="get" class="tgmenu__search-form">
                                        <div class="select-grp">
                                            ...
                                            <select name="category_id" class="form-select" id="course-cat" aria-label="Default select example" style="width: 150px">
