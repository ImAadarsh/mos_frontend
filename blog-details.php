                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="blog__details-wrapper">
                            ...
                            <div class="blog__details-content">
                                ...
                                <h3 class="title"><?php echo $final['title'] ?></h3>
                                <p><b><?php echo $final['subtitle'] ?></b></p>
                                <?php echo $final['content'] ?>
                                ...
                                <blockquote>
                                  ...
                                  <div class="blog__details-bottom">
                                    <div class="row align-items-center">
                                            ...
                                            <div class="tg-post-tag">
                                                ...
                                                <?php 
                                                    ...
                                                    foreach ($tag_array as $tag) { ?>
                                                        <li>
                                                        <a href="blog.php?tag=<?php echo urlencode($tag); ?>" rel="tag"><?php echo $tag; ?></a>
                                                        </li>
                                                    <?php } ?>
                                        ...
                                        <?php
                                            $id = $final['id']; // Replace this with your actual code to get the blog post ID
                                            $url = "https://magicofskills.com/blog-details.php?id=" . $id;
                                            ?>
                                            <div class="tg-post-social justify-content-start justify-content-md-end">
                                                ...
                                                <ul class="list-wrap p-0 mb-0">
                                                    ...
                                                    <li>
                                                        <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode($url); ?>" target="_blank">
                                                            <i class="fab fa-twitter"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode($url); ?>" target="_blank">
                                                            <i class="fab fa-linkedin-in"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="https://wa.me/?text=<?php echo urlencode($url); ?>" target="_blank">
