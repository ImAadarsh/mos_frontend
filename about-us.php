...
<head>
    ...
    <title>Magic Of Skills | About Us</title>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-9">
                        <div class="about__images-three tg-svg">
                            <img src="assets/img/Learn.png" alt="img">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-three">
                            ...
                            <p class="desc">At Magic of Skills, we believe that every student possesses unique talents and potential waiting to be discovered. Our mission is to provide a dynamic and engaging platform where students can learn new skills, explore their interests, and pave the way for a brighter future.</p>
                            ...
                            <div class="tg-button-wrap">
                                <a href="login.php" class="btn arrow-btn">Signup for free<img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-8">
                        <div class="section__title text-center mb-40">
                            ...
                            <p>Magic of Skills is more than just a learning platform – it's a community of curious minds and future leaders. Start your journey with us and discover the magic of skills that will shape your future. Sign up today and take the first step towards unlocking your full potential!</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="newsletter__content">
                            ...
                            <div class="newsletter__form">
                                <form action="controller/email.php" method="post" enctype="multipart/form-data">
                                    <input name="email" type="email" placeholder="Type your e-mail">
                                    <button name="newsletter" type="submit" class="btn">Subscribe Now</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5">
                        <div class="section__title text-center mb-50">
                            ...
                            <h2 class="title">What Students Think and Say About Magic of skills</h2>
                            <p>Together, let's make learning an adventure and transform the future, one skill at a time.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                                            ...
                                            <div class="testimonial__item-top">
                                                <div class="testimonial__author">
                                                    <div class="testimonial__author-thumb">
                                                        <img width="70px" src="assets/img/favicon.png" alt="img">
                                                    </div>
                                                    <div class="testimonial__author-content">
                                                        ...
                                                        <h2 class="title"><?php echo $testimonials['name'] ?></h2>
                                                    </div>
                                                </div>
                                            </div>
