...
<head>
    ...
    <title>Magic Of Skills | Our Workshops</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h3 class="title">
                                <?php if (isset($_GET['is_completed']) && in_array(0, $_GET['is_completed'])) {
                                    echo 'Upcoming Workshops';
                                } else {
                                    echo 'All Workshops';
                                } ?>
                            </h3>
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem"><?php if (isset($_GET['is_completed']) && in_array(0, $_GET['is_completed'])) {
                                    echo 'Workshops';
                                } else {
                                    echo 'Workshops';
                                } ?></span>
                                ...
                                <div class="courses-widget filter-card">
                                    <div class="filter-header">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 10H17M3 5H17M3 15H17" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round" />
                                        </svg>
                                                ...
                                                <li>
                                                    <div class="form-check custom-checkbox">
                                                        <input class="form-check-input" type="checkbox" name="category[]"
                                                            ...
                                                            id="cat_<?php echo $final['id']; ?>">
                                                        <label class="form-check-label"
                                                            for="cat_<?php echo $final['id']; ?>">
                                ...
                                <div class="courses-widget filter-card">
                                    <div class="filter-header">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10 2L12.09 7.26L17 8.27L13 12.14L13.82 17.02L10 14.77L6.18 17.02L7 12.14L3 8.27L7.91 7.26L10 2Z"
                                ...
                                <div class="courses-widget filter-card">
                                    <div class="filter-header">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            ...
                                            <path d="M10 6.5V10L12.5 12.5" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round" />
                                        </svg>
                                    ...
                                    <div class="courses-cat-list">
                                        <ul class="list-wrap">
                                            ...
                                            <li>
                                                <div class="form-check custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" name="skill[]"
                                                        value="beginner" id="skill_beginner">
                                            ...
                                            <li>
                                                <div class="form-check custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" name="skill[]"
                                                        value="intermediate" id="skill_intermediate">
                                            ...
                                            <li>
                                                <div class="form-check custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" name="skill[]"
                                                        value="advance" id="skill_advance">
                                    ...
                                    <div class="filter-header">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="currentColor" stroke-width="1.5" />
                                            <path
                                                d="M2.42188 18C2.42188 14.6863 5.10813 12 8.42188 12H11.5781C14.8919 12 17.5781 14.6863 17.5781 18V20H2.42188V18Z"
                                                stroke="currentColor" stroke-width="1.5" />
                                        </svg>
                                                ...
                                                <li>
                                                    <div class="form-check custom-checkbox instructor-item">
                                                        <input class="form-check-input" type="checkbox" name="instructor[]"
                                                            value="<?php echo $final['id']; ?>"
                                                            id="ins_<?php echo $final['id']; ?>">
                                                        <label class="form-check-label"
                                                            for="ins_<?php echo $final['id']; ?>">
                                                            <span class="checkmark"></span>
                                                            <?php if (!empty($final['photo'])): ?>
                                                                <img src="<?php echo $uri . $final['photo']; ?>"
                                                ...
                                                <div class="courses__item-content">
                                                    <ul class="courses__item-meta list-wrap">
                                                        <li class="courses__item-tag">
                                                            <a
                                                                href="courses.php?category=<?php echo $final['category_id']; ?>"><?php echo $final['category_name']; ?></a>
                                                        </li>
                                                        <li class="avg-rating"><a
                                                                href="controller/wishlist.php?workshop_id=<?php echo $final['id']; ?>"
                                                                class="courses__wishlist-one"><img
                                                                    src="assets/img/icons/heart02.svg" alt=""
                                                                    class="injectable"></a></li>
                                                    </ul>
                                                    <h5 class="title"><a
                                                            href="course-details.php?id=<?php echo $final['id']; ?>"><?php echo $final['name']; ?></a>
                                                    </h5>
                                                    <p class="author">By <a
                                                            href="#"><?php echo $final['trainer_name']; ?></a></p>
                                                    <div class="courses__item-bottom">
                                                        <div class="button">
                                                            <a href="course-details.php?id=<?php echo $final['id']; ?>">
                                                                <span
                                                                    class="text"><?php echo $final['is_completed'] ? 'View Details' : 'Enroll Now'; ?></span>
                                                                <i class="flaticon-arrow-right"></i>
                                                            </a>
                                                        </div>

                                                        <h5 class="price">₹<?php echo $final['is_completed'] ? $final['record_price'] : $final['price']; ?></h5>
                                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="courses__item courses__item-three shine__animate-item">
                                            <div class="courses__item-thumb">
                                                <a href="course-details.php?id=<?php echo $final['id']; ?>"
                                                    class="shine__animate-link">
                                                    <img height="560px" width="380px" style="width: 380px !important;"
                                                        src="<?php echo $uri . $final['icon'] ?>" alt="img">
                                            ...
                                            <div class="courses__item-content">
                                                <ul class="courses__item-meta list-wrap">
                                                    ...
                                                    <li class="price">
                                                        <del>₹<?php echo $final['cut_price']; ?></del>₹<?php echo $final['is_completed'] ? $final['record_price'] : $final['price']; ?>
                                                    </li>
                                                </ul>
                                                <h5 class="title"><a
                                                        href="course-details.php?id=<?php echo $final['id']; ?>"><?php echo $final['name']; ?></a>
                                                </h5>
                                                <p class="author">By <a href="#"><?php echo $final['trainer_name']; ?></a>
                                                </p>
                                                ...
                                                <div class="courses__item-bottom list-wrap">
                                                    ...
                                                    <li style="color: black; font-size:medium; margin-top: 10px;"
                                                        class="price">Date: <?php
                            ...
                            <nav class="pagination__wrap mt-30">
                                <ul class="list-wrap">
                                    <?php if ($current_page > 1): ?>
                                        <li><a href="courses.php?page=<?php echo $current_page - 1; ?>">&laquo; Previous</a>
                                        </li>
                                    <?php endif; ?>
                                    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                        <li class="<?php if ($i == $current_page)
                                            echo 'active'; ?>"><a
                                                href="courses.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php endfor; ?>
                                    <?php if ($current_page < $total_pages): ?>
                                        <li><a href="courses.php?page=<?php echo $current_page + 1; ?>">Next &raquo;</a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </nav>
