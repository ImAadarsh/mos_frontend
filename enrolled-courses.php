                                                        ...
                                                        <div class="courses__item courses__item-two shine__animate-item">
                                                            ...
                                                            <div class="courses__item-content courses__item-content-two">
                                                                ...
                                                                <div class="courses__item-content-bottom">
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <a href="#"><img style="border: 1px solid black; padding:2px; border-radius: 50%;" src="assets/img/icons/youtube.svgx" alt=""> Available Soon</a>
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <ul class="list-wrap">
                                                                    ...
                                                                    <?php if($workshop['is_completed']==1) { ?>
                                                                        <?php if($workshop['recording']==NULL) { ?>
                                                                            <li><i class="flaticon-arrow-right"></i> <a href="<?php echo $workshop['recording']; ?>">Recording Available Soon</a></li>
                                                                        <?php } else { ?>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <?php if($workshop['workshop_link']==NULL) { ?>
                                                                            <li><i class="flaticon-arrow-right"></i> <a href="<?php echo $workshop['workshop_link']; ?>">Join. Link Available Soon</a></li>
                                                                        <?php } else { ?>
                                                        ...
                                                        <div class="col-xl-6 col-md-6">
                                                            <div class="courses__item courses__item-two shine__animate-item">
                                                                ...
                                                                <div class="courses__item-bottom-two">
                                                                    <ul class="list-wrap">
                                                                        <li><i class="flaticon-clock"></i><?php echo date('d/m/y h:i A', strtotime($workshop['start_time'])); ?></li>
                                                                        <li><i class="flaticon-arrow-right"></i> <a href="<?php echo $workshop['workshop_link'] ? $workshop['workshop_link'] : '#'; ?>"><?php echo $workshop['workshop_link'] ? 'Join Workshop Now' : 'Join. Link Available Soon'; ?></a></li>
                                                                        <li><i class="flaticon-cross"></i> <a href="course-details.php?id=<?php echo $workshop['id']; ?>"></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xl-6 col-md-6">
                                                            <div class="courses__item courses__item-two shine__animate-item">
                                                                ...
                                                                <div class="courses__item-bottom-two">
                                                                    <ul class="list-wrap">
                                                                        <li><i class="flaticon-clock"></i><?php echo date('d/m/y h:i A', strtotime($workshop['start_time'])); ?></li>
                                                                        <li><i class="flaticon-arrow-right"></i> <a href="<?php echo $workshop['recording'] ? 'player.php?id='.$workshop['recording'] : '#'; ?>"><?php echo $workshop['recording'] ? 'View Recording' : 'Recording Available Soon'; ?></a></li>
                                                                        <li><i class="flaticon-cross"></i> <a href="course-details.php?id=<?php echo $workshop['id']; ?>"></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
