...
<head>
    ...
    <title>Magic Of Skills | Enrolled Courses</title>
    <?php include "include/private_page.php";
...
<body>
    ...
    <main class="main-area">
        ...
        // Fetch workshops data if paymentItems is not empty
                                                            ...
                                                            <div class="col-xl-6 col-md-6">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h5 class="title"><a
                                                                                href="course-details.php?id=<?php echo $workshop['id']; ?>"><?php echo $workshop['name']; ?></a>
                                                                        </h5>
                                                                        <div class="courses__item-content-bottom">
                                                                            <div class="author-two">
                                                                                <a
                                                                                    href="instructor-details.php?id=<?php echo $workshop['trainer_id']; ?>"><img
                                                                                        src="<?php echo $uri . $workshop['trainer_image']; ?>"
                                                                    ...
                                                                    <div class="courses__item-bottom-two">
                                                                        <ul class="list-wrap">
                                                                            <li><i
                                                                                    class="flaticon-clock"></i><?php echo date('d/m/y h:i A', strtotime($workshop['start_time'])); ?>
                                                                            </li>
                                                                            <?php if ($workshop['is_completed'] == 1) { ?>
                                                                                <?php if ($workshop['recording'] == NULL) { ?>
                                                                                    <li><i class="flaticon-arrow-right"></i> <a
                                                                                            href="<?php echo $workshop['recording']; ?>">Recording
                                                                                            Available Soon</a></li>
                                                                                <?php } else { ?>
                                                                                    <li><i class="flaticon-arrow-right"></i> <a
                                                                                            href="player.php?id=<?php echo $workshop['recording']; ?>">View
                                                                                            Recording</a></li>
                                                                                <?php } ?>
                                                                            <?php } else { ?>
                                                                                <?php if ($workshop['workshop_link'] == NULL) { ?>
                                                                                    <li><i class="flaticon-arrow-right"></i> <a
                                                                                            href="<?php echo $workshop['workshop_link']; ?>">Join.
                                                                                            Link Available Soon</a></li>
                                                                                <?php } else { ?>
                                                                                    <li><i class="flaticon-arrow-right"></i> <a
                                                                                            href="<?php echo $workshop['workshop_link']; ?>">Join
                                                                                            Workshop Now</a></li>
                                                                                <?php } ?>
                                                                            <?php } ?>
                                                                            <li><i class="flaticon-cross"></i> <a
                                                                                    href="course-details.php?id=<?php echo $workshop['id']; ?>"></a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="courses__item-bottom-two">
                                                                            <ul class="list-wrap">
                                                                                ...
                                                                                <li><i class="flaticon-arrow-right"></i> <a
                                                                                        href="<?php echo $workshop['workshop_link'] ? $workshop['workshop_link'] : '#'; ?>"><?php echo $workshop['workshop_link'] ? 'Join Workshop Now' : 'Join. Link Available Soon'; ?></a>
                                                                                </li>
                                                                                <li><i class="flaticon-cross"></i> <a
                                                                                        href="course-details.php?id=<?php echo $workshop['id']; ?>"></a>
                                                                                </li>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="courses__item-bottom-two">
                                                                            <ul class="list-wrap">
                                                                                ...
                                                                                <li><i class="flaticon-arrow-right"></i> <a
                                                                                        href="<?php echo $workshop['recording'] ? 'player.php?id=' . $workshop['recording'] : '#'; ?>"><?php echo $workshop['recording'] ? 'View Recording' : 'Recording Available Soon'; ?></a>
                                                                                </li>
                                                                                <li><i class="flaticon-cross"></i> <a
                                                                                        href="course-details.php?id=<?php echo $workshop['id']; ?>"></a>
                                                                                </li>
